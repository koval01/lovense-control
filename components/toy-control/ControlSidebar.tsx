...
export function ControlSidebar({
  ...
  return (
    <div className="w-full md:w-[152px] z-20 border-t md:border-t-0 md:border-l border-[var(--vkui--color_separator_secondary)] md:bg-[var(--vkui--color_background_content)]/50">
      <div className={`grid gap-1.5 md:gap-2 p-2 md:p-3 ${
        hasGroups
          ? patternCount > 1
        ...
        {actions.map((action) => {
          ...
          return (
            <button
              ...
              className={`h-12 md:h-20 rounded-lg md:rounded-xl px-1.5 md:px-2 flex flex-col items-center justify-center gap-1 md:gap-1.5 border transition-all ${
                action.active
                  ? 'border-[var(--vkui--color_stroke_accent)] bg-[var(--vkui--color_background_accent)] text-[var(--vkui--color_text_contrast)]'
                  : 'border-[var(--vkui--color_separator_secondary)] text-[var(--vkui--color_text_primary)] md:bg-[var(--vkui--color_background_secondary)]'
              } ${
