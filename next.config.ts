...
// initOpenNextCloudflareForDev() removed: it validates wrangler config during build,
// which fails on deleted_classes migration (class not in worker). Re-enable for local
// dev if you need Cloudflare bindings in next dev.
