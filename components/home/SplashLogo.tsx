    ...
    >
      <defs>
        ...
        >
          ...
          <stop offset="0.5" stopColor="#ff5bab" stopOpacity="0.98" />
      ...
      >
        ...
        <text
          ...
          style={{ fontFamily: '"Avenir Next", "SF Pro Display", Inter, system-ui, sans-serif', textTransform: 'uppercase', filter: 'drop-shadow(0 0 10px rgba(255, 91, 171, 0.38))' }}
        >
          LOVENSE
        </text>
      </motion.g>
